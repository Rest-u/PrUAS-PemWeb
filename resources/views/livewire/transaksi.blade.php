            ...
            <div class="row mt-2">
                <div class="col-8">
                    <div class="card border-primary">
                        <div class="card-body">
                            <h4 class="card-title">Invoice {{ $transaksiAktif->kode }} </h4>
                            <input type="text" class="form-control" placeholder="Invoice"
                                wire:model.live='kode'></input>
                ...
                <div class="col-4">
                    ...
                    <div class="card border-primary mt-2">
                        <div class="card-body">
                            ...
                            <input type="number" class="form-control" placeholder="Rp. " wire:model.live='bayar'>
                        </div>
                    </div>
                    <div class="card border-primary mt-2">
                        <div class="card-body">
                    ...
                    @if ($bayar)
                        @if ($kembalian < 0)
                            <div class="alert alert-danger" role="alert">Uang Kurang</div>
                        @elseif ($kembalian > 0)
